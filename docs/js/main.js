...
(0, _jquery2.default)(function () {
  ...
  var $dropArea = (0, _jquery2.default)('.dropArea');
  var $exifInfo = (0, _jquery2.default)('.exifInfo');
  var $previewArea = (0, _jquery2.default)('.previewArea');
  ...
  var analyzeExif = function analyzeExif(file, $infoBox, $imageBox) {
    ...
    _exifJs2.default.getData(file, function () {
      ...
      Object.keys(exif).forEach(function (key) {
        ...
        $tr.append((0, _jquery2.default)('<td>').addClass('exifHeader').text(exifUtil.getFieldNameLabel(key)));
        $tr.append((0, _jquery2.default)('<td>').addClass('exif_value').text(exifUtil.getExifValueLabel(key, exif[key])));
        $table.append($tr);
      });
